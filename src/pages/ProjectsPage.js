      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        ...
        <div className="grid grid-cols-2 gap-2 place-content-center-m-4">
           ...
           <div className="flex relative">
            <img className="absolute inset-0 w-full h-full object-cover object-center" src={img2}/>
          ...
          <div className="flex relative">
            <img className="absolute inset-0 w-full h-full object-cover object-center" src={img3}/>
            <div className="px-8 py-10 relative z-10 w-full bg-gray-300 opacity-0 hover:opacity-100">
          ...
          <a href="">
          <div className="flex relative">
            <img className="absolute inset-0 w-full h-full object-cover object-center" src={img4}/>
            <div className="px-8 py-10 relative z-10 w-full bg-gray-300 opacity-0 hover:opacity-100">
